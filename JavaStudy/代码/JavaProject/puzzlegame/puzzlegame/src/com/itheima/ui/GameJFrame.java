...
import com.itheima.domain.GameData;
...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    public GameJFrame(){
        ...
        File file = new File("puzzlegame/image/background.png");
    ...
    private void initJMenuBar() {
        ...
        File save = new File("puzzlegame/savedata");
        ...
        try {
            if (files != null) {
                for (int i = 0;i < files.length;i++) {
                    ...
                    ois.close();
                    int stp = gd.getStep();
                    saveJMenu.getItem(i).setText("存档" + i + "(" + stp + ")");
                    loadJMenu.getItem(i).setText("读档" + i + "(" + stp + ")");
                }
            }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem) {
            ...
            int idx = item.getText().charAt(2) - '0';
            try {
                ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("puzzlegame/savedata/save" + idx + ".data"));
                IoUtil.writeObj(oos,true,new GameData(data,path,x,y,step));
            } catch (IOException ex) {
                throw new RuntimeException(ex);
            }

            //修改标签文字
            item.setText("存档" + idx + "(" + step + ")");
            loadJMenu.getItem(idx).setText("读档" + idx + "(" + step + ")");
            ...
            try{
                ois = new ObjectInputStream(new FileInputStream("puzzlegame/savedata/save" + idx + ".data"));
            ...
            this.data = gd.getData();
            this.path = gd.getPath();
            this.x = gd.getX();
            this.y = gd.getY();
            this.step = gd.getStep();
